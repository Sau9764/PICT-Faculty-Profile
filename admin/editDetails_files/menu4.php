<div id="menu4" class="container tab-pane fade"><br>
	<div class="card mycard" id="journals" style="margin-bottom: 10px;">
		<div class="card-header" align="center">
			<h2>Journal Details
				<span><button class="personalclick btn btn-danger ml-2" data-toggle="modal" data-target="#delete_journal_model" style="float: right;" onclick="editpersonal()">Delete Record</button></span>

				<span><button class="personalclick btn btn-primary ml-2" data-toggle="modal" data-target="#add_journal_model" style="float: right;" onclick="editpersonal()">Add Record</button></span>
			...
			<div class="card-body">
				<?php
					...
					if($result1->num_rows>0){
						echo'<h5>Total Number of Journal Records  : <a href="#">'.$result1->num_rows.'</a></h5>
							<tr>
						...
						while($row1 = $result1->fetch_assoc()){
							...
							echo'<tr>
							<td> <input class="jdetails mytbstyle" type="text" name="jtitle[]" placeholder="'.$row1["jid"].'" disabled></td>
