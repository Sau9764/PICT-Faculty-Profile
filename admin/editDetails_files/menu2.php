<div id="menu2" class="container tab-pane fade"><br>
	<div id="qualifications" class="card mycard">
		<div class="card-header" align="center">
			<h2>Qualifications
				<span><button class="personalclick btn btn-danger ml-2" data-toggle="modal" data-target="#deleteQualiModel" style="float: right;" onclick="editpersonal()">Delete Record</button></span>
				<span><button class="personalclick btn btn-primary ml-2" data-toggle="modal" data-target="#AddQualiModel" style="float: right;" onclick="editpersonal()">Add Record</button></span>
